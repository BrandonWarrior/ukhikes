...
- **As a user**, I can register and log in so that I can access the site's features.  
  ...
  - Users should receive error messages for invalid login credentials.

- **As a user**, I can update my profile so that I can personalise my experience.  
  - Users can add/edit a display name and profile picture.  
  - Users can add a short bio to their profile.  
  - Profile updates should be reflected in posts and comments.

### **Epic 2: Post Management**  
- **As a user**, I can create hiking posts with title, content, location, and difficulty.  
  - Posts should be displayed on the homepage after submission.  
  - Users should receive confirmation upon successful post creation.

- **As a user**, I can browse posts by location and difficulty so that I can find hikes that interest me.  
  - Filtering results should update dynamically.  
  - Users can filter posts by location and difficulty.

### **Epic 3: Community Interaction**  
- **As a user**, I can comment on posts so that I can engage in discussions with other hikers.  
  - Users can add comments under hiking posts.  
  - Users can delete their own comments.

- **As a user**, I can upvote/downvote posts so that I can highlight helpful content.  
  - Users can upvote a post.  
  - Vote counts should be displayed next to posts.  
  - Users should not be able to vote on their own posts.

### **Epic 4: Post Organisation and Filtering**  
- **As a user**, I can filter posts by location and difficulty to find hikes that match my needs.  
  - This feature will be implemented in future updates, based on feedback and development progress.
...
- **As a user**, I can access the blog on any device so that I can browse hiking content easily.  
  ...
  - Navigation and layout must adapt to different screen sizes.  
  - Interactive elements (buttons, forms) should be easy to use on all devices.

### **Epic 6: Admin Moderation**  
- **As an admin**, I can delete inappropriate posts or comments to maintain a positive community.  
  - Admins can remove posts flagged as inappropriate.  
  - Users should be notified if their post is deleted.  
  - Deleted posts should no longer be visible to other users.
