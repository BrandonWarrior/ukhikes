...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'profiles', 'templates'),  # New templates directory for profiles app
            os.path.join(BASE_DIR, 'blog', 'templates'),  # Ensure blog templates are still accessible
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
